...
(function(){
    ...
    angular.module('app.controllers').controller('BasemapDetailsCtrl', ["$state", "BasemapsService", function($state, BasemapsService){
        //
        var vm = this;
        vm.basemap = {}
        vm.selected = [];
...
(function() {
	...
	angular.module('app.controllers').controller('ExportStyleCtrl', ["$state", "$timeout", "ExportService", function($state, $timeout, ExportService) {
    var vm = this;
		vm.exporter = {};
    vm.item = {};
    vm.style = {
