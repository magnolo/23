	...
	angular.module('app.routes').config(["$stateProvider", "$urlRouterProvider", "$locationProvider", function($stateProvider, $urlRouterProvider, $locationProvider) {
		...
		.state('app.index.mydata', {
			...
			.state('app.index.exports.details', {
				...
				auth: true,
				resolve: {
					exportItem: ["ContentService", "$stateParams", function(ContentService, $stateParams) {
						if ($stateParams.id == 0) return {
								items:[]
						};
...
(function() {
	...
	angular.module('app.controllers').controller('ExportCtrl', ["$state", "ContentService", function($state, ContentService) {
		//
		var vm = this;
		vm.exports = [];
		vm.options = {
...
(function(){
    ...
    angular.module('app.controllers').controller('ExportDetailsCtrl', ["$state", "exportItem", function($state, exportItem){
        //
        var vm = this;
