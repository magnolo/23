...
(function(){
    ...
    angular.module('app.controllers').controller('ExportCtrl', ["$state", function($state){
        //
        var vm = this;
        vm.exports = [];
        vm.options = {
...
(function(){
    ...
    angular.module('app.controllers').controller('ExportDetailsCtrl', ["$state", function($state){
        //
        var vm = this;
        vm.export = {
          list:[]
...
(function(){
    ...
    angular.module('app.controllers').controller('ExportStyleCtrl', function(){
        //
    });
