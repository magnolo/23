(function(){
    ...
    angular.module('app.controllers').controller('IndexMetaMenuCtrl', function($scope,$state, toastr, DataService,DialogService, IndexService){
      var vm = this;
      ...
      vm.saveData = saveData;
		...
		//Checks input for field length and returns iso type
